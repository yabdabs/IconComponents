...
const SvgAccordionExpand = props => (
  <svg viewBox="0 0 24 24" {...props}>
    <title>{"\n        Icon / Accordion / Expand - small\n    "}</title>
    <defs>
      <path
        className="Accordion-Expand_svg__path-01"
        ...
        id="Accordion-Expand_svg__a"
      />
    </defs>
    <g fillRule="evenodd">
      <mask id="Accordion-Expand_svg__b">
        <use xlinkHref="#Accordion-Expand_svg__a" />
      </mask>
      <use xlinkHref="#Accordion-Expand_svg__a" />
...
export default SvgAccordionExpand;
