  ...
  <svg width={24} height={24} {...props}>
    <defs>
      <path
        ...
        id="Caret_-_up_svg__a"
      />
    </defs>
    <g fillRule="evenodd">
      <mask id="Caret_-_up_svg__b">
        <use xlinkHref="#Caret_-_up_svg__a" />
      </mask>
      <use transform="matrix(1 0 0 -1 0 25)" xlinkHref="#Caret_-_up_svg__a" />
      <g mask="url(#Caret_-_up_svg__b)">
